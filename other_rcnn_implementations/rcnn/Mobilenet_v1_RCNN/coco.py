...
from Mobilenet_v1_RCNN.config import Config
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_bn', required=False,
                        ...
                        type=bool)
    parser.add_argument('--ABLATION_FLAGS', required=False,
                        default=False,
                        metavar='/path/to/ABLATION_FLAGS.json',
                        help='Ablation flags stored as JSON')
    ...
    ABLATION_FLAGS = {} if args.ABLATION_FLAGS is False else json.load(open(args.ABLATION_FLAGS, 'r'))
    print("ABLATION_FLAGS: ", ABLATION_FLAGS)
    ...
    if args.command == "train":
        model = modellib.MaskRCNN(mode="training", config=config,
                                  model_dir=args.logs, ABLATION_FLAGS=ABLATION_FLAGS)
    else:
